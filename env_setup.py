...
# MAGIC CREATE TABLE IF NOT EXISTS dev_catalog.raw.commodity_tests (
...
# MAGIC INSERT INTO dev_catalog.raw.commodity_tests (reference_number, goods_location, country_of_origin, commodity_code, commodity_description, tested_for, status) VALUES 
